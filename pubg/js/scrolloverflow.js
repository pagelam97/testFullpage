import * as utils from '../../fullPage.js/src/js/common/utils.js';
import { getOptions } from '../../fullPage.js/src/js/common/options.js';
import { getState, state } from '../../fullPage.js/src/js/common/state.js';
import { fireCallback } from '../../fullPage.js/src/js/callbacks/fireCallback.js';
import { isResponsiveMode } from '../../fullPage.js/src/js/responsive.js';
import { isMacDevice, isTouchDevice, isTouch, win, doc, isIE11 } from '../../fullPage.js/src/js/common/constants.js';
import { $body } from '../../fullPage.js/src/js/common/cache.js';
import { 
    AUTO_HEIGHT_RESPONSIVE,
    IS_OVERFLOW,
    OVERFLOW,
    OVERFLOW_SEL
} from '../../fullPage.js/src/js/common/selectors.js';
import { EventEmitter } from '../../fullPage.js/src/js/common/eventEmitter.js';
import { getSlideOrSection } from '../../fullPage.js/src/js/common/utilsFP.js';
import { getSectionFromPanel } from '../../fullPage.js/src/js/sections.js';
import { events } from '../../fullPage.js/src/js/common/events.js';
import { isInsideInput } from '../../fullPage.js/src/js/common/utils.js';
